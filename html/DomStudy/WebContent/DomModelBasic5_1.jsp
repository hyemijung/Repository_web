...
<script type="text/javascript">
	...
	var childObjArr1 = document.getElementById('list').childNodes;/*자식을 찾을때는 childNodes 복수로 적어줘야  */
	...
	for (var i = 0; i < childObjArr.length; i++) {
 		childObjArr[i].style.fontStyle = 'oblique';   /*childNodes 에서는 안된다 */
 		childObjArr[i].style.color = '#f00';   
